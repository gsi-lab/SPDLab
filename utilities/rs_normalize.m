function N = rs_normalize(A,varargin)
...
%   deviation 1. If A is a matrix or a table, NORMALIZE operates on each 
%   column separately. If A is an N-D array, NORMALIZE operates along the 
